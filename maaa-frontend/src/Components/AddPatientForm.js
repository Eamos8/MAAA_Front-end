    ...
    render() {
        return (
            <Popup trigger={<button
                class="bg-blue-500 hover:bg-blue-600 text-white border-blue-400 border rounded font-bold mx-4 my-2 py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                type="button">
                    + Patient
                </button>}
                position="right top"
