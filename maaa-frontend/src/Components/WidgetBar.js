...
class WidgetBar extends React.Component {
    ...
    render() {
        return (
            <Popup trigger={<div class='absolute right-0 top-0 ' ><FontAwesomeIcon icon={faEllipsisH} /></div>}
                position="left top"
